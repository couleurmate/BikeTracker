...
char pubkey[] = "pub-c-cb75b5a3-ecd6-4158-abe9-c96eec58ba44";
char subkey[] = "sub-c-bb3668c2-642e-11e5-85c0-0619f8945a4f";
...
void setup()
{
    ...
    //attachGPRS(const char *apn, const char *username, const char *password);
     ...
     while (!LGPRS.attachGPRS("m2minternet.proximus.be", "", "")) 
    {
    Serial.println(" . ");
    delay(1000);
    }
